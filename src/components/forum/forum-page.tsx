...
import { Rocket, BrainCircuit, Bot, Link2, Briefcase, BarChart, BookOpen, MessageSquare, ShieldCheck, FileText, Share2, Ban, FolderGit2, Mic } from 'lucide-react';
...
const StatsSection = () => {
    ...
    return (
        <section ref={sectionRef} className="py-16 px-8 bg-gray-50">
